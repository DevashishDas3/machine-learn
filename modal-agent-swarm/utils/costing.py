...
def estimate_run_cost(
    ...
    llm_rate = SETTINGS.gpu_hourly_cost_usd.get(SETTINGS.llm_gpu, 1.5)
    ...
    total_cost = (impl_hours * impl_rate) + (tuning_hours * llm_rate) + (plan_hours * llm_rate)
    return CostEstimate(
