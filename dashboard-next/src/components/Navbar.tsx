      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          <Link
            ...
            className="group flex items-center gap-2 border border-azure/50 bg-azure/10 px-4 py-1.5 font-mono text-xs uppercase tracking-widest text-azure transition-all hover:border-azure hover:bg-azure/20"
          >
            <svg
              className="h-4 w-4"
              fill="currentColor"
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <svg
              className="h-5 w-5 text-paper/60 transition-colors hover:text-paper"
              fill="currentColor"
              viewBox="0 0 24 24"
              aria-hidden="true"
            >
